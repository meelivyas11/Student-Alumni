...
public class a_DeleteReunion extends HttpServlet {
    ...
    throws ServletException, IOException, NamingException, SQLException {
        ...
        try {
	         ...
	         ps = con.prepareStatement(DBUtils.GET_SPECIFIC_REUNION, ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
    ...
    throws ServletException, IOException {
        try {
            ...
            Logger.getLogger(a_DeleteReunion.class.getName()).log(Level.SEVERE, null, ex);
