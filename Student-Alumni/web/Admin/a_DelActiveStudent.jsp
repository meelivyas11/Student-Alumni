<%-- 
    Document   : a_DelActiveStudent
    Created on : Mar 23, 2009, 12:53:46 PM
    Author     : Meeli Vyas
--%>
		...
		<table border="10" width="100%">
			<tr>
				...
				<td width="80%" height="85%">
					...
					%> 
					<sql:setDataSource var="db" dataSource="<%=ds%>" /> <sql:query
				...
				<br>
					...
					<table width=100% border=3 align="left">
						...
						<form action="a_DelActiveStudents">
							<pre>
							<b>Enter The GRNO of Record To Be Deleted :<input type="text"
									name="delgrno" value="" size="6" />
							</b>
